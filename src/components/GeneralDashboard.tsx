...
export default function GeneralDashboard() {
  ...
  // Fetch contract owner and questions
  useEffect(() => {
      ...
      <div className="min-h-screen theme-bg">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="card p-6 text-center">
            <h2 className="text-2xl font-bold mb-4 theme-text-primary">Dashboard</h2>
    ...
    <div className="space-y-6">
      ...
      <div className="card p-6">
        ...
        <p className="theme-text-secondary mb-4">
          Welcome to your dashboard! In the new contract, you stake HYPE directly when submitting answers to questions.
        </p>
        
        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
          <p className="text-sm theme-text-secondary">Dashboard Overview</p>
          <p className="text-lg font-semibold theme-text-primary">Manage your funds and platform settings</p>
        </div>
      </div>
      ...
      <div className="card p-6">
        ...
        {activeTab === 'platform' && isOwner && (
          <div className="space-y-6">
            <h3 className="text-xl font-semibold mb-4 theme-text-primary">Platform Management</h3>
            <p className="theme-text-secondary">
              Platform configuration management is not supported in the current contract version.
            </p>
          </div>
        )}
      </div>
